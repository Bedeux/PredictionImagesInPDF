...
image_names = os.listdir(path_to_project+"/1. Data/Labelisation/Images Pixelisées/")
...
for file_name in image_names:
    n+=1
    print(n)
    path = path_to_project+"/1. Data/Labelisation/Images Pixelisées/"+file_name
...
def create_characters_values(files_of_image):
    ...
    for imagei in files_of_image:  
        n+=1
        print(n)
        path = path_to_project+"/1. Data/Labelisation/Images/" + str(imagei)
...
all_image = os.listdir(path_to_project+'/1. Data/Labelisation/Images')
dico = create_characters_values(all_image)

target_values = {}
for image in all_image:
    target_values[image] = [1]
